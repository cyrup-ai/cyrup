...
- Each question: 2–4 concrete options with brief implication descriptions, plus an `Other` option
...
- If the user selects `Other`, ask a plain-text follow-up for their answer and record their response verbatim
