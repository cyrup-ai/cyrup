...
> warnings' cargo doc -p cyrup-ext-subagents --no-deps` fails at HEAD on
> `discovery/runtime_registry.rs:18` (`crate::extension::executor::SubagentExecutor` — `mod executor`
