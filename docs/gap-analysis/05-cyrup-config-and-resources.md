...
| CFG-078 | low | upstream-drift | S | `fullscreenExitOutput` and `fullscreenCopyOnSelect` (v0.84.4 additions) are not modelled — **filed 2026-09-04** (version-lag skim, `v0.84.1..v0.84.4`). |
...
## CFG-078 — `fullscreenExitOutput` and `fullscreenCopyOnSelect` (v0.84.4 additions) are not modelled
