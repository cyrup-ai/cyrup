...
| CFG-079 | low | upstream-drift | S | `defaultTools` (v0.84.4 addition) — an initial built-in tool selection — is not modelled — **filed 2026-09-04** (version-lag skim, `v0.84.1..v0.84.4`). |
