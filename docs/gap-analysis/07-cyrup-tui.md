...
## TUI-004 — No live colour-scheme sync; `/reload` does not re-apply themes — **CLOSED 2026-09-05**
...
> in exchange: crossterm has already spent the shifted codepoint by the time an event reaches cyrup,
