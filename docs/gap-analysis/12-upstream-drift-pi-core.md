...
test defect owned elsewhere. `DRIFT-041` leaves one NEW low residual behind it — the `renderedTools`
/ `ToolHtmlRenderer` + ANSI-to-HTML seam — recorded in its row, not filed as a separate ID.
...
## ~~DRIFT-041~~ — Session HTML export is a 131-line text dump against pi's 5,021-line templated document — **CLOSED 2026-09-05**
...
## DRIFT-004 — RPC `bash`: `UserBashEventResult.operations` backend seam unported — **CLOSED 2026-09-05**
