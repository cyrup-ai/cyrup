...
use cyrup_provider::api::compat::thinking_level_key;
use cyrup_provider::collection::{
...
fn token_budget_providers_clamp_max_to_high() {
    use cyrup_provider::utils::simple_options::{adjust_max_tokens_for_thinking, clamp_reasoning};
...
fn every_embedded_catalog_parses_non_empty() {
    let providers = cyrup_provider::all_providers();
...
fn no_catalog_still_remaps_xhigh_onto_max() {
    ...
    for p in cyrup_provider::all_providers() {
