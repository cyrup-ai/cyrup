...
use cyrup_ext_subagents::prompt_runtime::{
...
use cyrup_ext_subagents::spawn::nested_events::FANOUT_CHILD_ENV;
...
fn the_env_keys_are_the_ones_the_spawn_overlay_writes() {
    ...
    let authorized: std::collections::HashMap<&str, &str> =
        cyrup_ext_subagents::spawn::nested_events::child_role_env(true).into_iter().collect();
