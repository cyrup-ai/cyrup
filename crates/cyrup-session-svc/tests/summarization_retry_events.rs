...
fn collect(session: &cyrup_session_svc::AgentSession) -> Arc<Mutex<Vec<AgentSessionEvent>>> {
...
async fn session_with_a_dropping_summarization(fx: &Fixture) -> cyrup_session_svc::AgentSession {
