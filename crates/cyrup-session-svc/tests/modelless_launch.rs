...
use cyrup_session_svc::{ProviderResolver, SessionBuilder, SessionConfig, SessionServiceError};
...
async fn empty_catalog_builds_a_modelless_session_with_the_no_models_banner() {
    ...
    assert_eq!(
        ...
        Some(cyrup_session_svc::auth_guidance::format_no_models_available_message().as_str()),
