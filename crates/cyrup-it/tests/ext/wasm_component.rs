...
//!
//! The fixture is built by `cargo build -p cyrup-ext-sdk --target wasm32-wasip2` (wasm32-wasip2
...
/// [`HostServices`] backend, not just `GuestState`'s own bookkeeping (`ext.guest().notifications()`/
