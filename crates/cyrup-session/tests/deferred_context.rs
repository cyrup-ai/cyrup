...
//!
//! Integration tests are their own crate and inherit no lint config, hence the file-level allow.
...
use cyrup_session::context::context_message_role;
use cyrup_session::entry::Entry;
